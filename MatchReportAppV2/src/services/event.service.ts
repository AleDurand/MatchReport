...
let event = [
  ...
  new Event({ id: 3, name: 'Descalificacion con informe', minute: 23.3,  type: 'beer', desc: ' lo aniquila de forma que no pueda hacer deporte nunca mas en su vida',team: 'Visita'}),
